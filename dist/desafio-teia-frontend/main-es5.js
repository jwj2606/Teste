...
/* harmony import */ var cdk_table_exporter__WEBPACK_IMPORTED_MODULE_32__ = __webpack_require__(/*! cdk-table-exporter */ "./node_modules/cdk-table-exporter/fesm5/cdk-table-exporter.js");
/* harmony import */ var mat_table_exporter__WEBPACK_IMPORTED_MODULE_33__ = __webpack_require__(/*! mat-table-exporter */ "./node_modules/mat-table-exporter/fesm5/mat-table-exporter.js");
/**
 * @fileoverview This file was generated by the Angular template compiler. Do not edit.
 *
 * @suppress {suspiciousCode,uselessCode,missingProperties,missingOverride,checkTypes}
...
/* harmony import */ var mat_table_exporter__WEBPACK_IMPORTED_MODULE_20__ = __webpack_require__(/*! mat-table-exporter */ "./node_modules/mat-table-exporter/fesm5/mat-table-exporter.js");
/* harmony import */ var cdk_table_exporter__WEBPACK_IMPORTED_MODULE_21__ = __webpack_require__(/*! cdk-table-exporter */ "./node_modules/cdk-table-exporter/fesm5/cdk-table-exporter.js");
...
var DadosTableComponent = /** @class */ (function () {
    function DadosTableComponent(service, spinnerService) {
    ...
    DadosTableComponent.prototype.ngOnInit = function () {
        this.dataSource.paginator = this.paginator;
        this.dataSource.sort = this.sort;
        this.getAllReports();
    };
    DadosTableComponent.prototype.getAllReports = function () {
        var _this = this;
        this.showTable = false;
        var resp = this.service.apiServicoConsome();
        resp.subscribe(function (report) {
            _this.dataSource.data = report;
            var column_names = []; //Array com confi das colunas
            var jsonObj = _this.dataSource.data;
            //console.log('jsonObj[0]',jsonObj[0][1])
            $.each(Object.keys(jsonObj[0]), function (idx, obj) {
                var dadoIncluir = '{' + obj + ':' + typeof jsonObj[0][obj] + '}';
    ...
    DadosTableComponent.prototype.applyFilter = function (filterValue) {
        this.dataSource.filter = filterValue.trim().toLowerCase();
    };
    DadosTableComponent.prototype.clearTable = function () {
        this.dataSource.data = [];
    };
    DadosTableComponent.prototype.addData = function () {
        this.getAllReports();
    };
    return DadosTableComponent;
}());
...
var DesafioTeiaService = /** @class */ (function () {
    function DesafioTeiaService(http) {
        this.http = http;
    }
    DesafioTeiaService.prototype.apiServicoConsome = function () {
